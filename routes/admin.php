...
Route::middleware(['auth', 'verified', 'role.admin'])->prefix('suug')->as('admin.')->group(function () {
    ...
    Route::post('comments/{comment}/reply', [ProductCommentController::class, 'reply'])->name('comments.reply');
    Route::patch('comments/{comment}/approve', [ProductCommentController::class, 'approve'])->name('comments.approve');
    Route::patch('comments/{comment}/reject', [ProductCommentController::class, 'reject'])->name('comments.reject');
