...
class SettingsUpdateRequest extends FormRequest
{
    ...
    public function rules(): array
    {
        return [
            ...
            'vakif_katilim_merchant_id' => ['nullable', 'string', 'max:255'],
            'vakif_katilim_terminal_id' => ['nullable', 'string', 'max:255'],
            'vakif_katilim_user_name' => ['nullable', 'string', 'max:255'],
            'vakif_katilim_enc_key' => ['nullable', 'string', 'max:255'],
            'vakif_katilim_test_mode' => ['boolean'],
            'vakif_katilim_disable_3d_hash_check' => ['boolean'],
            'vakif_katilim_payment_api' => ['nullable', 'string', 'max:500'],
            'vakif_katilim_gateway_3d' => ['nullable', 'string', 'max:500'],
            'vakif_katilim_gateway_3d_host' => ['nullable', 'string', 'max:500'],
